...
DEPRECATED: Use <<_ifloor>> instead.
...
DEPRECATED: Use <<_iround>> instead.
...
[cols=">h,<9"]
|===============================================================================
|Description|Alias for <<_ee>>.
|     Syntax|`ee_match_any <named-automata>`
|      Types|String
|     Module|ee
|    Version|0.7
|===============================================================================

This operator was renamed to `ee`.

DEPRECATED: Use <<_ee>> instead.
