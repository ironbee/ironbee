...
static ib_status_t rule_enable_all(ib_rule_t *rule, void *cbdata) {
    assert(rule != NULL);
    return IB_OK;
}

static ib_status_t rule_enable_by_tag(ib_rule_t *rule, void *cbdata) {
    assert(rule != NULL);
    assert(cbdata != NULL);
...
static ib_status_t rule_enable_by_id(ib_rule_t *rule, void *cbdata) {
    assert(rule != NULL);
    assert(cbdata != NULL);
