...
TEST_F(ErrorPage, file_not_found) {
    std::string config =
        std::string(
            ...
            "LoadModule \"ibmod_block.so\"\n"
            "SensorId B9C1B52B-C24A-4309-B9F9-0EF4CD577A3E\n"
            "SensorName UnitTesting\n"
            "SensorHostname unit-testing.sensor.tld\n"
            "BlockMethod status\n"
            "BlockStatus 500\n"
            "ErrorPageMap 500 missing_file.html\n"
            "<Site test-site>\n"
...
TEST_F(ErrorPage, relative_filename) {
    std::string config =
        std::string(
            ...
            "BlockMethod status\n"
            "BlockStatus 500\n"
            "ErrorPageMap 500 ../tests/error_page.html\n\n"
            "<Site test-site>\n"
            "   SiteId AAAABBBB-1111-2222-3333-000000000000\n"
            "   Hostname somesite.com\n"
            "</Site>\n"
...
TEST_F(ErrorPage, basic_file) {
    std::string config =
        std::string(
            ...
            "SensorName UnitTesting\n"
            "SensorHostname unit-testing.sensor.tld\n"
            "ErrorPageMap 500 error_page.html\n"
            "BlockMethod status\n"
            "BlockStatus 500\n"
            "<Site test-site>\n"
            "   SiteId AAAABBBB-1111-2222-3333-000000000000\n"
            "   Service *:*\n"
            "   Hostname *\n"
            "   Action id:action01 rev:1 phase:request setflag:blockingMode block:phase\n"
            "</Site>\n"
        );
