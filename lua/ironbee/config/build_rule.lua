...
-------------------------------------------------------------------
-- IronBee - Configuration Build Rule Function
--
-- IronBee configuration build_rule function.
--
-- The rule building function is so complex that it is isolated into
-- this file and is used by the ironbee/config.lua module.
--
-- @module ironbee.config.build_rule
--
...
-- @return Status code.
-------------------------------------------------------------------
local build_rules = function(ib_engine)
