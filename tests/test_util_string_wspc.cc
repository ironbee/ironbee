...
class TestIBUtilStrWspcBase : public ::testing::Test
{
public:
    TestIBUtilStrWspcBase(const char *fn) : m_callbuf(fn) {
...
{
public:
    TestIBUtilStrWspcStr(const char *fn)
        : TestIBUtilStrWspcBase(fn),
          m_inbuf(new char[BufSize+1]),
          m_outbuf(BufSize)
    {
    }

    ~TestIBUtilStrWspcStr()
    {
        delete [] m_inbuf;
    }
...
{
public:
    TestIBUtilStrWspcRemove( ) : TestIBUtilStrWspcStr( FnName() )
    { };
    ...
    ib_status_t RunTestFn(char *in, char **out, ib_bool_t *modified) {
        return ::ib_str_wspc_remove(m_mpool, in, out, modified);
    }
};
...
{
public:
    TestIBUtilStrWspcCompress( ) : TestIBUtilStrWspcStr( FnName() )
    { };
    ...
    ib_status_t RunTestFn(char *in, char **out, ib_bool_t *modified) {
        return ::ib_str_wspc_compress(m_mpool, in, out, modified);
    }
};
...
{
public:
    TestIBUtilStrWspcEx(const char *fn)
        : TestIBUtilStrWspcBase(fn),
          m_inbuf(BufSize),
          m_outbuf(BufSize)
    {
...
{
public:
    TestIBUtilStrWspcRemoveEx( ) : TestIBUtilStrWspcEx( FnName() )
    { };
...
{
public:
    TestIBUtilStrWspcCompressEx( ) : TestIBUtilStrWspcEx( FnName() )
    { };
...
TEST_F(TestIBUtilStrWspcRemove, test_str_wspc_remove)
{
    RunTests( str_test_data );
}

TEST_F(TestIBUtilStrWspcCompress, test_str_wspc_compress)
{
    RunTests( str_test_data );
}

// Test the ex versions with normal strings
TEST_F(TestIBUtilStrWspcRemoveEx, test_str_wspc_remove_strex)
{
}

TEST_F(TestIBUtilStrWspcCompressEx, test_str_wspc_compress_strex)
{
    RunTests( str_test_data );
}
...
TEST_F(TestIBUtilStrWspcRemoveEx, test_str_wspc_remove_ex)
{
    RunTests( ex_test_data );
}

TEST_F(TestIBUtilStrWspcCompressEx, test_str_wspc_compress_ex)
{
    RunTests( ex_test_data );
}
