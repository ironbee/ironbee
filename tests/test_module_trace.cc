...
//////////////////////////////////////////////////////////////////////////////
/// @file
/// @brief IronBee &mdash; Trace module tests
/// 
...
/// @test Test trace module - load module programatically
TEST(TestIronBee, test_module_trace_load_module)
{
    ib_engine_t *ib;
    ib_module_t *m;
    ...
    ibtest_engine_module_load(ib,
                              IB_XSTRINGIFY(MODULE_BASE_PATH) "/ibmod_trace.so",
                              &m);
...
/// @test Test trace module - initialize module by including source
TEST(TestIronBee, test_module_trace_init_module)
{
    ib_engine_t *ib;
    ib_module_t *m;
