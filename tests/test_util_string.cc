...
public:
    ...
    const char *Stringize(const char *fn,
                          const char *haystack,
                          size_t haystack_len,
                          const char *needle,
                          size_t needle_len,
                          char *buf, size_t buflen)
    {
        if ( (haystack == NULL) && (needle == NULL) ){
            snprintf(buf, buflen,
                     "%s_ex(NULL,%zd,NULL,%zd)",
                     fn, haystack_len, needle_len);
        }
        else if (haystack == NULL) {
            snprintf(buf, buflen,
                     "%s_ex(NULL,%zd,\"%.*s\",%zd)",
                     fn, haystack_len, (int)needle_len, needle, needle_len);
        }
        else if (needle == NULL) {
            snprintf(buf, buflen,
                     "%s_ex(\"%.*s\",%zd,NULL,%zd)",
                     fn, (int)haystack_len, haystack, haystack_len, needle_len);
        }
        else {
            snprintf(buf, buflen,
                     "%s_ex(\"%.*s\",%zd,\"%.*s\",%zd)",
                     fn, (int)haystack_len, haystack, haystack_len,
    ...
    virtual void RunTestImpl(int line,
                             const char *haystack,
                             size_t haystack_len,
                             const char *needle,
                             size_t needle_len,
...
class TestIBUtilStrStrEx : public TestIBUtilStrEx
{
public:
...
class TestIBUtilStrRStrEx : public TestIBUtilStrEx
{
public:
    void RunTestImpl(int line,
                     const char *haystack,
...
/// @test Test util string library - strrstr_ex()
TEST_F(TestIBUtilStrRStrEx, test_strrstr_ex_errors)
{
    RunTest(__LINE__, "", "", NULL);
    RunTest(__LINE__, "abc", "", NULL);
    RunTest(__LINE__, "", "abc", NULL);
...
TEST_F(TestIBUtilStrRStrEx, test_strrstr_ex)
{
    const char *haystack;
    ...
    haystack = " aa";
    RunTest(__LINE__, haystack, "a",   haystack+2);
    haystack = " aa";
    RunTest(__LINE__, haystack, "aa",  haystack+1);
    haystack = " aa";
    RunTest(__LINE__, haystack, "aaa", NULL);
    ...
    RunTest(__LINE__, haystack, "abc", haystack+0);
    haystack = "abcabc";
    RunTest(__LINE__, haystack, "abc", haystack+3);
    haystack = "aabc";
    RunTest(__LINE__, haystack, "abc", haystack+1);
    haystack = "ababc";
    RunTest(__LINE__, haystack, "abc", haystack+2);
...
TEST_F(TestIBUtilStrRStrEx, test_strrstr_ex_nul1)
{
    const char *haystack;
    ...
    RunTest(__LINE__, haystack, 2, "a",   haystack+0);
    haystack = "a\0a";
    RunTest(__LINE__, haystack, 3, "a",   haystack+2);
    haystack = "\0a\0a";
    RunTest(__LINE__, haystack, 4, "a",   haystack+3);
    haystack = "a\0a";
    RunTest(__LINE__, haystack, 3, "aa",  NULL);
    haystack = "a\0a";
    RunTest(__LINE__, haystack, 3, "ab",  NULL);
    ...
    RunTest(__LINE__, haystack, 4, "aa",  haystack+2);
    haystack = "aa\0aa";
    RunTest(__LINE__, haystack, 4, "aa",  haystack+3);
    haystack = "\0ab";
    RunTest(__LINE__, haystack, 3, "ab",  haystack+1);
    haystack = "a\0b";
    RunTest(__LINE__, haystack, 3, "b",   haystack+2);
...
TEST_F(TestIBUtilStrRStrEx, test_strrstr_ex_nul2)
{
    const char *haystack;
    ...
    RunTest(__LINE__, haystack, 2, "a\0",  2,  haystack+0);
    haystack = "a\0a";
    RunTest(__LINE__, haystack, 3, "a\0",  2,  haystack+2);
    haystack = "\0a\0a";
    RunTest(__LINE__, haystack, 4, "a\0",  2,  haystack+3);
    haystack = "a\0a";
    RunTest(__LINE__, haystack, 3, "a\0a", 3,  haystack+2);
    haystack = "a\0a";
    RunTest(__LINE__, haystack, 3, "a\0b", 3,  NULL);
    ...
    RunTest(__LINE__, haystack, 5, "a\0a", 3,  haystack+1);
    haystack = "aa\0aa\0\a";
    RunTest(__LINE__, haystack, 5, "a\0a", 3,  haystack+4);
    ...
    RunTest(__LINE__, haystack, 7, "abc\0", 4, haystack+0);
    haystack = "abc\0abc";
    RunTest(__LINE__, haystack, 7, "abc",   4, haystack+4);
    haystack = "a\0abc";
    RunTest(__LINE__, haystack, 5, "\0abc", 4, haystack+1);
    haystack = "a\0abc";
    RunTest(__LINE__, haystack, 5, "abc\0", 4, NULL);
