...
/**
 * @file
 * @brief IronBee --- Memory Manager: Mpool Lite Implementation
 *
...
static void *ib_mm_mpool_lite_alloc(
    size_t  size,
    void   *cbdata
)
{
...
static ib_status_t ib_mm_mpool_lite_register_cleanup(
...
ib_mm_t ib_mm_mpool_lite(ib_mpool_lite_t *mpl)
{
    ...
    ib_mm_t mm = {
        &ib_mm_mpool_lite_alloc, mpl,
        &ib_mm_mpool_lite_register_cleanup, mpl
    };
    return mm;
}
