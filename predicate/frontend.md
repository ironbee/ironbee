...
To use, simply load `ibmod_predicate` and make use of the functions in the `Predicate` table.  If you are using it outside of IronBee, then load `predicate.lua` as a module.
