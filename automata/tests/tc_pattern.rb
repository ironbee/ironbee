...
class TestPattern < Test::Unit::TestCase
  ...
  def test_multiple
    ...
    automata_test(words, [ACGEN, '-p'], "test_multiple") do |dir, eudoxus_path|
      ...
      assert_equal([3, 4, 6, 7, 8].to_set, output_substrings[words[3]])
      assert_equal([1, 2, 5, 9, 10, 11, 12].to_set, output_substrings[words[4]])
      assert_equal([1, 3, 4, 6, 7, 8].to_set, output_substrings[words[5]])
