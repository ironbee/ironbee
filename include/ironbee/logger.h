 ...
 *
 * @param[in] logger The logger to add this function too.
 * @param[in] format_name The name to register @a format under.
 ...
 * @param[in] logger The logger to use.
 * @param[in] name The name of the function.
 * @param[out] format The format functions and associated callback data.
 *
 * @returns
 * - IB_OK On success.
 * - IB_EINVAL If a function by the given name was found, but is the wrong
...
/**
 * Wrap the last 4 parameters in an @ref ib_logger_format_t.
 *
