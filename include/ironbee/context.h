...
/**
 * Get the IronBee memory manager.
 *
 ...
 */
ib_mm_t DLL_PUBLIC ib_context_get_mm(const ib_context_t *ctx);
 ...
 * @returns Status code
 */
ib_context_t DLL_PUBLIC *ib_context_engine(const ib_engine_t *ib);
