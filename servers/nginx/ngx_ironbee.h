...
ib_status_t ngxib_conn_init(ib_engine_t *ib, ib_state_event_type_t event,
...
void ngxib_logger(const ib_engine_t *ib, ib_log_level_t level,
    const char *file, int line, const char *fmt, va_list ap, void *dummy);
...
extern ib_engine_t *ngx_ironbee;
